public class Questions {
    public static void main(String[] args){
        ...
        //1.1.2. Describe what happens if you omit the following in HelloWorld.java
            //a. public = When removed, this shows a run-time error that the main method cannot be found, and shows the correct usage:  public static void main(String[] args)
            //b. static = When removed, this shows another run-time error that main method is not static, and again shows the correct usage: public static void main(String[] args)
            //c. void = When removed, this shows a compile-time error, saying that the return type is required and an approximate location of where the offending part is
            //d. args = When removed, this shows a compile-time error, saying that an identifier is expected and an approximate location of where the offending part is 

        //1.1.3. Describe what happens if you misspell the following in HelloWorld.java
            //a. public = When misspelled, this shows a compile-time error and an approximate location of the offending word
            //b. static = When misspelled, this shows a compile-time error and an approximate location of the offending word; and additionally another error for not having a valid return type
            //c. void = When misspelled, this shows a compile-time error with offending word and the specific class where the offending word is located
