public class Ruler{
    public static void main(String[] args){
        ...
        //Java immediately converts the other value of the operand into a String when one of the other operands is alr a String
        String a = "1234";
        int b = 99;
        String c = a + b;
        ...
        //Trying to parse values as input arguments
            //Note: When the values assigned to a specific data type are not compatible, a compile-time error "incompatible types" will be displayed during a compile attempt
